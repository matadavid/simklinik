    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">SIM KLINIK UNTAN</a>
            </div>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="{{url ('/lihat-dokter')}}">
                                            <span>LIHAT</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{url ('/input-dokter')}}">
                                            <span>Tambah</span>
                                        </a>
                                    </li>
                                </ul>
